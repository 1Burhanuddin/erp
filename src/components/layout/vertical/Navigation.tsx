...
// Type Imports
import type { Mode } from '@/types/coreTypes'
...
// Style Imports
import navigationCustomStyles from '@/utils/navigationCustomStyles'
import VerticalNav from '@/components/menu/VerticalNav'
import NavHeader from '@/components/menu/NavHeader'
import NavCollapseIcons from '@/components/menu/NavCollapseIcons'
